...
public class JFontChooser extends JComponent
{
     ...
     */
    protected String i18n(String code) { return I18N.process(code); }
    
    /**
     * 
     */
    private static final long serialVersionUID = 6165415754855457279L;
    // class variables
    /**
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2809690787227543086L;
	protected String ACTION_NAME = "·OK·";
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7173119245505660399L;
	protected String ACTION_NAME;
        private JDialog dialog;

        protected DialogCancelAction(JDialog dialog)
        {
            ACTION_NAME = i18n("·Cancel·");
            this.dialog = dialog;
            putValue(Action.DEFAULT, ACTION_NAME);
            putValue(Action.ACTION_COMMAND_KEY, ACTION_NAME);
            putValue(Action.NAME, (ACTION_NAME));
    ...
    protected JDialog createDialog(Component parent)
    {
        ...
        // Next line modified by Professor Jonatan Gomez for i18n
        JDialog dialog = new JDialog(frame, i18n("·Select Font·"), true);
    ...
    protected JPanel getFontFamilyPanel()
    {
        if (fontNamePanel == null)
        {
            ...
            // Next line modified by Professor Jonatan Gomez for i18n
            JLabel label = new JLabel(i18n("·Font Name·"));
    ...
    protected JPanel getFontStylePanel()
    {
        if (fontStylePanel == null)
        {
            ...
            // Next line modified by Professor Jonatan Gomez for i18n
            JLabel label = new JLabel(i18n("·Font Style·"));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
    ...
    protected JPanel getFontSizePanel()
    {
        if (fontSizePanel == null)
        {
            ...
            // Next line modified by Professor Jonatan Gomez for i18n
            JLabel label = new JLabel(i18n("·Font Size·"));
            label.setHorizontalAlignment(JLabel.LEFT);
            label.setHorizontalTextPosition(JLabel.LEFT);
    ...
    protected JPanel getSamplePanel()
    {
        if (samplePanel == null)
        {
            ...
            Border titledBorder = BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(), i18n("·Sample·"));
